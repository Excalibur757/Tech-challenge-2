...
export default function Home() {
  ...
  const handleTransactionSubmit = (novaTransacao: FormularioType & { upload?: boolean; arquivo?: string }) => {
    const novosExtratos = adicionarTransacao(extratos, novaTransacao as FormularioType);
